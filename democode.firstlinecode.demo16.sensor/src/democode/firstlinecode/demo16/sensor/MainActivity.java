	...
	public void onClick(View v) {
		switch (v.getId()) {
			case R.id.activity_main_button1:
				 intent = new Intent(MainActivity.this,IlluminationSensorActivity.class);
				 startActivity(intent);
				break;
			case R.id.activity_main_button2:
				 intent = new Intent(MainActivity.this,AcceleratedSpeedActivity.class);
				 startActivity(intent);
				break;
			case R.id.activity_main_button3:
				 intent = new Intent(MainActivity.this,DirectionSensorActivity.class);
				 startActivity(intent);
				break;
